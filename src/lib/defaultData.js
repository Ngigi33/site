// This is the shape of cv.json. Every list item needs a stable `id` —
// use makeId() when creating new entries in the admin panel.
export const defaultData = {
  profile: {
    name: 'Your Name',
    title: 'Your Title — e.g. Software Engineer',
    tagline: 'One sentence on what you do and what you care about.',
  ...
  education: [
    {
      ...
      details: 'Honors, relevant coursework, activities — optional.'
    }
  ],
  projects: [
    {
